  ...
  return (
    <section id="contact" className="py-24 px-6 bg-[var(--paper)]">
      <div className="max-w-xl mx-auto">
        ...
        {status === 'sent' ? (
          <div className="text-center py-12 px-6 bg-violet-50 dark:bg-violet-950/30 rounded-2xl border border-violet-200 dark:border-violet-800">
            <div className="text-4xl mb-3">🎉</div>
            <h3 className="text-gray-900 dark:text-white font-bold text-xl mb-2">Message sent!</h3>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <button
              ...
              className="w-full py-3 bg-violet-500 hover:bg-violet-600 disabled:opacity-60 text-white font-semibold rounded-xl transition-colors shadow-md shadow-violet-200 dark:shadow-violet-900"
            >
